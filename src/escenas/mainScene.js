...
export default class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        let stands0 = new Stand(this, this.sys.game.config.width * 1/4, this.sys.game.config.height * 1/4, [0,1,22,-1,-1,25,8], false);
        let stands1 = new Stand(this, this.sys.game.config.width * 1/4, this.sys.game.config.height * 1/4 + 64, [0,1,-3,-1,-1,9,8], true);
        ...
        stands0.shelfs.array.forEach(element => {
            this.physics.add.collider(player, element)
        });
